...
public class F2calculateErrorPer1000 {

    private static String originalPath = "/data/.../experiments/datasets/original/malaria_per_1000/";
    private static String privatePath = "/data/.../experiments/datasets/private/malaria_per_1000/";
    private static String datasetInfo = "/data/.../experiments/datasets/malaria_per_1000_datasets.csv";
    private static String output = "/data/.../experiments/malaria_per_1000.csv";
