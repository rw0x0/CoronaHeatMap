...
public class F1calculateError {

    private static String originalPath = "/data/.../experiments/datasets/original/malaria/";
    private static String privatePath = "/data/.../experiments/datasets/private/malaria/";
    private static String datasetInfo = "/data/.../experiments/datasets/malaria_datasets.csv";
    private static String output = "/data/.../experiments/malaria.csv";
