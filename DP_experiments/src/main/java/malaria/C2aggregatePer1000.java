...
public class C2aggregatePer1000 {
    
    // do the aggregation, i.e. sum of trips for the given users

    private static String input = "/data/.../datasets/malaria/malaria_average_trips_per_1000.csv";
    private static String datasetsFile = "/data/.../experiments/datasets/malaria_datasets.csv";
    private static String outputFolder = "/data/.../experiments/datasets/original/malaria_per_1000/";
