...
public class D2createBashFilePer1000 {

    private static String output = "/data/.../experiments/datasets/run_malaria_per_1000.sh";
    ...
    public static void main(String args[]) throws Exception {
        ...
        for (int i = 0; i <= maxID; i++) {
            for (double privacy = minPrivacy; privacy <= maxPrivacy; privacy += step) {
                ...
                bw.write(plainPath + " ./original/malaria_per_1000/did_" + i + ".txt"
                        + " ./private/malaria_per_1000/did_" + i + "_e_" + privacy + ".txt"
                        + " " + privacy + "\n");
            }
